...
// 1차 시도, 8-readonly-2 참고
// type AppendToObject<T extends object, U, V> = {[P in keyof T]: T[P]} & { U : V }
// type ex1 = AppendToObject<test1, 'home', boolean>;
// { key: "cat"; value: "green"; } & { U: boolean; }

// 2차 시도
// type AppendToObject<T extends object, U extends string, V> = {[P in keyof T]: T[P]} & Record<U, V>;
// type ex1 = AppendToObject<test1, 'home', boolean>;
