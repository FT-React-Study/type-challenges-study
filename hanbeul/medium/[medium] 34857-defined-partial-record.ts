...
// type Subsets<T extends string> =
//   T extends infer U ? U extends string ? [U] | [U, ...Subsets<Exclude<T, U>>] : never : never;

// type MergeKeys<T, K extends string[]> =
//   K extends [infer Head extends keyof T, ...infer Tail extends string[]]
//     ? { [P in Head]: T[P] } & MergeKeys<T, Tail>
//     : {};

// type DefinedPartial<T extends object> =
//   Subsets<Keys<T>> extends infer K
//     ? K extends string[]
//       ? MergeKeys<T, K>
//       : never
//     : never;
