...
// type Triangular<N extends number, I extends never[] = [], J extends never[] = [], C extends never[] = []> = 
//   I['length'] extends N ?
//     C['length'] :
//     J['length'] extends [...I, never]['length'] ?
//       Triangular<N, [...I, never], J, [...C, ...J]>:
//       Triangular<N, I, [...J, never], C>;

type Triangular<N extends number, I extends never[] = [], C extends never[] = []> = 
  I['length'] extends N ?
      C['length'] :
      Triangular<N, [...I, never], [...C, ...[...I, never]]> ;
