...
type UnsignedPercentageParser<A extends string> = A extends `${infer Num}%` ? [Num, "%"] : [A, ""];

type PercentageParser<A extends string> = A extends `${infer Sign extends "+" | "-"}${infer Rest}` ? [Sign,...UnsignedPercentageParser<Rest>] : ["", ...UnsignedPercentageParser<A>]
